...
const Home = () => {
  return (
    <div className="w-full h-full flex items-center justify-center flex-col gap-20 bg-white dark:bg-background dark:bg-cover dark:bg-[url('/bg.jpg')]">
      ...
      <div className="flex w-full flex-col items-center justify-center gap-8 md:flex-row">
        <div className="flex min-h-[200px] w-full max-w-[442px] flex-col gap-4 rounded-lg border p-6 transition-all duration-200 ease-in-out hover:scale-110 dark:bg-gray-900">
